...
const std::string object_cao = "/home/tsuchida/Program/generic/model/teabox/teabox.cao";
const std::string object_init = "/home/tsuchida/Program/generic/model/teabox/teabox.init";
const std::string object_xml = "/home/tsuchida/Program/generic/model/teabox/teabox.xml";
vpColVector v;
...
int main(int argc, char** argv)
{
    ...
    tracker.initClick(Imot, object_init, true);
    tracker.getPose(cdMo);
